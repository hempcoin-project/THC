...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send hemp"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Hempcoin address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive hemp"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving hemp"));
