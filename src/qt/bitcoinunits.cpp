...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Hempcoins"));
    case mBTC: return QString(QObject::tr("Milli-Hempcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Hempcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
