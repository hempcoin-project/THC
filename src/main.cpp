...
unsigned int nStakeMinAge = 60 * 60 * 24 * 45;	// Growing Season Starts at 6 Weeks
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	// Growing Seasons of 6 Weeks each after that
unsigned int nStakeTargetSpacing = 60;			// 1 Minute block spacing

int64 nChainStartTime = 1393868740;
